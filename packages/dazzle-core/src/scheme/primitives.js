 ...
 */
import { FunctionObj, makeNumber, makeBoolean, makePair, makeString, makeSymbol, makeVector, makeChar, makeNode, makeNodeList, theNilObj, theTrueObj, theFalseObj, } from './elobj.js';
import { EMPTY_NODE_LIST } from '../grove/index.js';
/**
 * Arithmetic primitive: +
 * Port from: primitive.cxx Plus::primitiveCall
 */
const plusPrimitive = (args) => {
    let sum = 0;
    let exact = true;
 ...
 */
const greaterThanPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('> requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const numericEqualPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('= requires at least 2 arguments');
    }
    const first = args[0].asNumber();
 ...
 */
const lessThanOrEqualPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('<= requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const greaterThanOrEqualPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('>= requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const stringLengthPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const stringAppendPrimitive = (args) => {
    let result = '';
    for (const arg of args) {
 ...
 */
const exactToInexactPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const inexactToExactPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const denominatorPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const rationalizePrimitive = (args) => {
    if (args.length !== 2) {
...
const stringRefPrimitive = (args) => {
    ...
    return { asChar: () => ({ value: str.value[Math.floor(idx.value)] }) };
};
/**
 * String primitive: substring
 * Port from: primitive.cxx Substring::primitiveCall
 */
const substringPrimitive = (args) => {
    if (args.length !== 3) {
 ...
 */
const stringEqualPrimitive = (args) => {
    if (args.length < 2) {
 ...
 */
const stringLessPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('string<? requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const numberToStringPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const stringToNumberPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const symbolToStringPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const stringToSymbolPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const makeVectorPrimitive = (args) => {
    if (args.length < 1 || args.length > 2) {
 ...
 */
const vectorLengthPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const vectorFillPrimitive = (args) => {
    if (args.length !== 2) {
 ...
 */
const charUpcasePrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const integerToCharPrimitive = (args) => {
    if (args.length !== 1) {
    ...
    return { asChar: () => ({ value: String.fromCharCode(num.value) }) };
};
 ...
 * Returns #f for now since we don't have port objects yet
 */
const outputPortPredicate = (args) => {
    if (args.length !== 1) {
 ...
 */
const stringUpcasePrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const stringDowncasePrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const reverseInPlacePrimitive = (args) => {
    if (args.length !== 1) {
        throw new Error('reverse! requires exactly 1 argument');
    }
 ...
 */
const vectorCopyPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 * Port from: OpenJade extensions
 */
const booleanEqualPrimitive = (args) => {
    if (args.length < 2) {
 ...
 * Port from: OpenJade extensions
 */
const symbolEqualPrimitive = (args) => {
    if (args.length < 2) {
 ...
 */
const numberToStringRadixPrimitive = (args) => {
    if (args.length < 1 || args.length > 2) {
 ...
 */
const deleteDuplicatesPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const concatenatePrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const stringToVectorPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const vectorToStringPrimitive = (args) => {
    if (args.length !== 1) {
...
function areEqual(obj1, obj2) {
    ...
    if (vec1 && vec2) {
        ...
        for (let i = 0; i < vec1.elements.length; i++) {
            if (!areEqual(vec1.elements[i], vec2.elements[i]))
                return false;
        }
        return true;
    }
 ...
 */
const properListPredicate = (args) => {
    if (args.length !== 1) {
 ...
 */
const circularListPredicate = (args) => {
    if (args.length !== 1) {
 ...
 */
const dottedListPredicate = (args) => {
    if (args.length !== 1) {
 ...
 */
const bitwiseAndPrimitive = (args) => {
    if (args.length === 0) {
 ...
 */
const bitwiseIorPrimitive = (args) => {
    if (args.length === 0) {
        return makeNumber(0, true);
    }
    let result = 0;
 ...
 */
const bitwiseXorPrimitive = (args) => {
    if (args.length === 0) {
        return makeNumber(0, true);
    }
    let result = 0;
 ...
 */
const bitwiseNotPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const arithmeticShiftPrimitive = (args) => {
    if (args.length !== 2) {
 ...
 */
const quotientRemainderPrimitive = (args) => {
    if (args.length !== 2) {
    ...
    return makePair(makeNumber(quotient, n1.exact && n2.exact), makePair(makeNumber(remainder, n1.exact && n2.exact), theNilObj));
};
// ============ Additional String Operations ============
/**
 ...
 */
const stringNullPredicate = (args) => {
    if (args.length !== 1) {
 ...
 */
const stringContainsPredicate = (args) => {
    if (args.length !== 2) {
 ...
 */
const stringPrefixPredicate = (args) => {
    if (args.length !== 2) {
 ...
 */
const stringSuffixPredicate = (args) => {
    if (args.length !== 2) {
 ...
 */
const stringIndexPrimitive = (args) => {
    if (args.length !== 2) {
 ...
 */
const stringReversePrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const stringTrimPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const exactIntegerPredicate = (args) => {
    if (args.length !== 1) {
 ...
 */
const makeRectangularPrimitive = (args) => {
    if (args.length !== 2) {
 ...
 */
const circularListPrimitive = (args) => {
    if (args.length === 0) {
        return theNilObj;
    }
 ...
 */
const appendInPlacePrimitive = (args) => {
    if (args.length === 0) {
        return theNilObj;
    }
    if (args.length === 1) {
 ...
 */
const lsetIntersectionPrimitive = (args) => {
    if (args.length === 0) {
        return theNilObj;
    }
    if (args.length === 1) {
 ...
 */
const callWithValuesPrimitive = (args) => {
    if (args.length !== 2) {
...
const unfoldPrimitive = (args) => {
    ...
    // Build result list
    let result = tailGen && tailGen.isPrimitive()
 ...
 */
const unfoldRightPrimitive = (args) => {
    if (args.length < 4 || args.length > 5) {
    ...
    let seed = args[3];
    let result = args.length === 5 ? args[4] : theNilObj;
 ...
 */
const openInputFilePrimitive = (args) => {
    if (args.length !== 1) {
 ...
 * Stub implementation (no real file I/O yet)
 */
const openOutputFilePrimitive = (args) => {
    if (args.length !== 1) {
 ...
 * Stub implementation
 */
const closeInputPortPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 * Stub implementation
 */
const closeOutputPortPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 * Stub implementation (no real file I/O yet)
 */
const callWithInputFilePrimitive = (args) => {
    if (args.length !== 2) {
 ...
 * Stub implementation (no real file I/O yet)
 */
const callWithOutputFilePrimitive = (args) => {
    if (args.length !== 2) {
 ...
 */
const nodeListLengthPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const emptyNodeListPrimitive = (args) => {
    if (args.length !== 0) {
 ...
 */
const nodeListFirstPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const nodeListRestPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const attributesPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const attributeStringPrimitive = (args) => {
    if (args.length !== 2) {
 ...
 */
const descendantsPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const childNumberPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const caaarPrimitive = (args) => {
    if (args.length !== 1) {
        throw new Error('caaar requires exactly 1 argument');
    }
    const p1 = args[0].asPair();
    if (!p1)
        throw new Error('caaar: not a pair');
    const p2 = p1.car.asPair();
    if (!p2)
        throw new Error('caaar: car is not a pair');
    const p3 = p2.car.asPair();
    if (!p3)
        throw new Error('caaar: caar is not a pair');
    return p3.car;
};
/**
 * List accessor: caadr
 ...
 */
const caadrPrimitive = (args) => {
    if (args.length !== 1) {
        throw new Error('caadr requires exactly 1 argument');
    }
    const p1 = args[0].asPair();
    if (!p1)
        throw new Error('caadr: not a pair');
    const p2 = p1.cdr.asPair();
    if (!p2)
        throw new Error('caadr: cdr is not a pair');
    const p3 = p2.car.asPair();
    if (!p3)
        throw new Error('caadr: cadr is not a pair');
    return p3.car;
};
/**
 * List accessor: cadar
 ...
 */
const cadarPrimitive = (args) => {
    if (args.length !== 1) {
        throw new Error('cadar requires exactly 1 argument');
    }
    const p1 = args[0].asPair();
    if (!p1)
        throw new Error('cadar: not a pair');
    const p2 = p1.car.asPair();
    if (!p2)
        throw new Error('cadar: car is not a pair');
    const p3 = p2.cdr.asPair();
    if (!p3)
        throw new Error('cadar: cdar is not a pair');
    return p3.car;
};
/**
 * List accessor: caddr
 ...
 */
const caddrPrimitive = (args) => {
    if (args.length !== 1) {
        throw new Error('caddr requires exactly 1 argument');
    }
    const p1 = args[0].asPair();
    if (!p1)
        throw new Error('caddr: not a pair');
    const p2 = p1.cdr.asPair();
    if (!p2)
        throw new Error('caddr: cdr is not a pair');
    const p3 = p2.cdr.asPair();
    if (!p3)
        throw new Error('caddr: cddr is not a pair');
    return p3.car;
};
/**
 * List accessor: cdaar
 ...
 */
const cdaarPrimitive = (args) => {
    if (args.length !== 1) {
        throw new Error('cdaar requires exactly 1 argument');
    }
    const p1 = args[0].asPair();
    if (!p1)
        throw new Error('cdaar: not a pair');
    const p2 = p1.car.asPair();
    if (!p2)
        throw new Error('cdaar: car is not a pair');
    const p3 = p2.car.asPair();
    if (!p3)
        throw new Error('cdaar: caar is not a pair');
    return p3.cdr;
};
/**
 * List accessor: cdadr
 ...
 */
const cdadrPrimitive = (args) => {
    if (args.length !== 1) {
        throw new Error('cdadr requires exactly 1 argument');
    }
    const p1 = args[0].asPair();
    if (!p1)
        throw new Error('cdadr: not a pair');
    const p2 = p1.cdr.asPair();
    if (!p2)
        throw new Error('cdadr: cdr is not a pair');
    const p3 = p2.car.asPair();
    if (!p3)
        throw new Error('cdadr: cadr is not a pair');
    return p3.cdr;
};
/**
 * List accessor: cddar
 ...
 */
const cddarPrimitive = (args) => {
    if (args.length !== 1) {
        throw new Error('cddar requires exactly 1 argument');
    }
    const p1 = args[0].asPair();
    if (!p1)
        throw new Error('cddar: not a pair');
    const p2 = p1.car.asPair();
    if (!p2)
        throw new Error('cddar: car is not a pair');
    const p3 = p2.cdr.asPair();
    if (!p3)
        throw new Error('cddar: cdar is not a pair');
    return p3.cdr;
};
/**
 * List accessor: cdddr
 ...
 */
const cdddrPrimitive = (args) => {
    if (args.length !== 1) {
        throw new Error('cdddr requires exactly 1 argument');
    }
    const p1 = args[0].asPair();
    if (!p1)
        throw new Error('cdddr: not a pair');
    const p2 = p1.cdr.asPair();
    if (!p2)
        throw new Error('cdddr: cdr is not a pair');
    const p3 = p2.cdr.asPair();
    if (!p3)
        throw new Error('cdddr: cddr is not a pair');
    return p3.cdr;
};
 ...
 */
const caaaaRPrimitive = (args) => {
    if (args.length !== 1) {
        throw new Error('caaaar requires exactly 1 argument');
    }
    const p1 = args[0].asPair();
    if (!p1)
        throw new Error('caaaar: not a pair');
    const p2 = p1.car.asPair();
    if (!p2)
        throw new Error('caaaar: car is not a pair');
    const p3 = p2.car.asPair();
    if (!p3)
        throw new Error('caaaar: caar is not a pair');
    const p4 = p3.car.asPair();
    if (!p4)
        throw new Error('caaaar: caaar is not a pair');
    return p4.car;
};
/**
 ...
 */
const caaaDrPrimitive = (args) => {
    if (args.length !== 1) {
        throw new Error('caaadr requires exactly 1 argument');
    }
    const p1 = args[0].asPair();
    if (!p1)
        throw new Error('caaadr: not a pair');
    const p2 = p1.cdr.asPair();
    if (!p2)
        throw new Error('caaadr: cdr is not a pair');
    const p3 = p2.car.asPair();
    if (!p3)
        throw new Error('caaadr: cadr is not a pair');
    const p4 = p3.car.asPair();
    if (!p4)
        throw new Error('caaadr: caadr is not a pair');
    return p4.car;
};
/**
 ...
 */
const caadDrPrimitive = (args) => {
    if (args.length !== 1) {
        throw new Error('caaddr requires exactly 1 argument');
    }
    const p1 = args[0].asPair();
    if (!p1)
        throw new Error('caaddr: not a pair');
    const p2 = p1.cdr.asPair();
    if (!p2)
        throw new Error('caaddr: cdr is not a pair');
    const p3 = p2.cdr.asPair();
    if (!p3)
        throw new Error('caaddr: cddr is not a pair');
    const p4 = p3.car.asPair();
    if (!p4)
        throw new Error('caaddr: caddr is not a pair');
    return p4.car;
};
/**
 ...
 */
const caddDrPrimitive = (args) => {
    if (args.length !== 1) {
        throw new Error('cadddr requires exactly 1 argument');
    }
    const p1 = args[0].asPair();
    if (!p1)
        throw new Error('cadddr: not a pair');
    const p2 = p1.cdr.asPair();
    if (!p2)
        throw new Error('cadddr: cdr is not a pair');
    const p3 = p2.cdr.asPair();
    if (!p3)
        throw new Error('cadddr: cddr is not a pair');
    const p4 = p3.cdr.asPair();
    if (!p4)
        throw new Error('cadddr: cdddr is not a pair');
    return p4.car;
};
/**
 ...
 */
const cdaaArPrimitive = (args) => {
    if (args.length !== 1) {
        throw new Error('cdaaar requires exactly 1 argument');
    }
    const p1 = args[0].asPair();
    if (!p1)
        throw new Error('cdaaar: not a pair');
    const p2 = p1.car.asPair();
    if (!p2)
        throw new Error('cdaaar: car is not a pair');
    const p3 = p2.car.asPair();
    if (!p3)
        throw new Error('cdaaar: caar is not a pair');
    const p4 = p3.car.asPair();
    if (!p4)
        throw new Error('cdaaar: caaar is not a pair');
    return p4.cdr;
};
/**
 ...
 */
const cdaaDrPrimitive = (args) => {
    if (args.length !== 1) {
        throw new Error('cdaadr requires exactly 1 argument');
    }
    const p1 = args[0].asPair();
    if (!p1)
        throw new Error('cdaadr: not a pair');
    const p2 = p1.cdr.asPair();
    if (!p2)
        throw new Error('cdaadr: cdr is not a pair');
    const p3 = p2.car.asPair();
    if (!p3)
        throw new Error('cdaadr: cadr is not a pair');
    const p4 = p3.car.asPair();
    if (!p4)
        throw new Error('cdaadr: caadr is not a pair');
    return p4.cdr;
};
/**
 ...
 */
const cddaArPrimitive = (args) => {
    if (args.length !== 1) {
        throw new Error('cddaar requires exactly 1 argument');
    }
    const p1 = args[0].asPair();
    if (!p1)
        throw new Error('cddaar: not a pair');
    const p2 = p1.car.asPair();
    if (!p2)
        throw new Error('cddaar: car is not a pair');
    const p3 = p2.cdr.asPair();
    if (!p3)
        throw new Error('cddaar: cdar is not a pair');
    const p4 = p3.cdr.asPair();
    if (!p4)
        throw new Error('cddaar: cddar is not a pair');
    return p4.car;
};
/**
 ...
 */
const cddddRPrimitive = (args) => {
    if (args.length !== 1) {
        throw new Error('cddddr requires exactly 1 argument');
    }
    const p1 = args[0].asPair();
    if (!p1)
        throw new Error('cddddr: not a pair');
    const p2 = p1.cdr.asPair();
    if (!p2)
        throw new Error('cddddr: cdr is not a pair');
    const p3 = p2.cdr.asPair();
    if (!p3)
        throw new Error('cddddr: cddr is not a pair');
    const p4 = p3.cdr.asPair();
    if (!p4)
        throw new Error('cddddr: cdddr is not a pair');
    return p4.cdr;
};
 ...
 */
const stringToListPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const listToStringPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const makeStringPrimitive = (args) => {
    if (args.length < 1 || args.length > 2) {
 ...
 */
const stringFillPrimitive = (args) => {
    if (args.length !== 2) {
 ...
 */
const stringCopyPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const stringGreaterPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('string>? requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const stringLessOrEqualPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('string<=? requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const stringGreaterOrEqualPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('string>=? requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const stringCiEqualPrimitive = (args) => {
    if (args.length < 2) {
 ...
 */
const stringCiLessPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('string-ci<? requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const stringCiGreaterPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('string-ci>? requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const stringCiLessOrEqualPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('string-ci<=? requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const stringCiGreaterOrEqualPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('string-ci>=? requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const charGreaterPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('char>? requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const charLessOrEqualPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('char<=? requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const charGreaterOrEqualPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('char>=? requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const charCiEqualPrimitive = (args) => {
    if (args.length < 2) {
 ...
 */
const charCiLessPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('char-ci<? requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const charCiGreaterPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('char-ci>? requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const charCiLessOrEqualPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('char-ci<=? requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const charCiGreaterOrEqualPrimitive = (args) => {
    if (args.length < 2) {
        throw new Error('char-ci>=? requires at least 2 arguments');
    }
    for (let i = 0; i < args.length - 1; i++) {
 ...
 */
const charAlphabeticPredicate = (args) => {
    if (args.length !== 1) {
 ...
 */
const charNumericPredicate = (args) => {
    if (args.length !== 1) {
 ...
 */
const charWhitespacePredicate = (args) => {
    if (args.length !== 1) {
 ...
 */
const charUpperCasePredicate = (args) => {
    if (args.length !== 1) {
 ...
 */
const charLowerCasePredicate = (args) => {
    if (args.length !== 1) {
 ...
 */
const vectorToListPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
const listToVectorPrimitive = (args) => {
    if (args.length !== 1) {
 ...
 */
export const standardPrimitives = {
    // Arithmetic - basic
